...
public class Vehicle_Details extends Baseclass_Monkeycap {
	...
	public void user_lands_in_Choose_your_vehicle_screen() throws Throwable {
		vehicle_DetailsPage = new Vehicle_DetailsPage(Baseclass_Monkeycap.driver);
	...
	public void user_click_on_PROCEED_button() throws Throwable {
		Baseclass_Monkeycap.clickonWebelement(vehicle_DetailsPage.proceed_btn());
